...
app_bundle="$project_root/.build/app/Rinvio Dev.app"
...
test "$(plutil -extract CFBundleDisplayName raw "$app_bundle/Contents/Info.plist")" = "Rinvio Dev"
test "$(plutil -extract CFBundleExecutable raw "$app_bundle/Contents/Info.plist")" = "Rinvio"
test "$(plutil -extract CFBundleIdentifier raw "$app_bundle/Contents/Info.plist")" = "com.keishingu.rinvio.dev"
